...
public class Stats extends Controller {
    ...
    public static void index() {
        ...
        TestResult testResult = TestResult.find("test = ? and account = ? order by resultDate desc", test, account).first();
        ...
        @SuppressWarnings("JpaQlInspection") Query query = JPA.em().createQuery("select t.sortOrder - 1, avg(a.val) " +
